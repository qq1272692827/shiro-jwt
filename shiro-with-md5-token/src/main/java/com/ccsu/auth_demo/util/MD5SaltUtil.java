package com.ccsu.auth_demo.util;
...
public class MD5SaltUtil {
    ...
    public static void main(String[] args) {
        ...
        // 获取加盐后的MD5值
        String ciphertext = MD5SaltUtil.getSaltMD5(plaintext);
        System.out.println("加盐后MD5：" + ciphertext);
        System.out.println("是否是同一字符串:" + MD5SaltUtil.getSaltverifyMD5(plaintext, ciphertext));
    }
